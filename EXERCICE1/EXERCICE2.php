...
<?php
    // Qst1 :
        $employes = [
            "employe1"=>["nom"=>"azzat","poste"=>"consultant","salaire"=>15000],
            "employe2"=>["nom"=>"mello","poste"=>"Developpeur web","salaire"=>25000],
    ...
    // Qst3 :
        $users = [
            ...
            "user1"=>["email"=>"AzzatNouamane@gmail.com","password"=>123456789],
            "user2"=>["email"=>"Azzat.Nouamane@gmail.com","password"=>43218465],
            "user3"=>["email"=>"Azz.Nouam@gmail.com","password"=>20050435],
        ];
        $email = $_POST["email"];
